...
namespace SDKLibrary
{
    ...
    public partial class Device : ICloneable
    {
        ...
        /// <summary>
        /// Sonradan eklendi. Class'în yeni bir kopyasını oluşturur.
        /// </summary>
        /// <returns></returns>
        public object Clone()
        {
       ...
       // internal bool IsSending { get; private set; }
        ...
        public void EndToSend(string strError = "")
        {
        ...
        {
            // 连接已经结束当做下线处理 (Bağlantı, çevrimdışı işleme olarak sonlandırıldı)
        ...
        /// <summary>
        /// Cihazın heartbeat mesajını gönderir eğer, ciahz online ise geriye true, offline ise false döner.
        /// </summary>
        /// <returns>true or false, device heartbeat status</returns>
        public bool GetHeartbeat()
        {
            try
            {
                ...
                {
                    EndToSend();
                    //Console.WriteLine("Cihaz bağlantısı yok -> " + this.GetDeviceInfo().deviceID);
                    return false;
                }

                else
                {
                    //Console.WriteLine($"Cihaz bağlantısı var! -> {this.GetDeviceInfo().deviceID}");
                    return true;
                }
        ...
        /// <summary>
        /// 发送确认协议版本命令 (Protokol sürümünü onayla komutunu gönder)
        /// </summary>
        ...
        public UploadFileInfo AddUploadFile(string filePath, bool tempFile = false, HFileType type = HFileType.kauto)
        {
            try
            {
                ...
                FileStream fs = File.Open(filePath, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite);
        ...
        {
            //_sendQueue.Clear(); // sonradan eklendi!
            ContinueUploadFile();
        }
       ...
       /// </summary>
        ...
        /// <summary>
        /// 获取字体信息 (Yazı tipi bilgilerini al)
        /// </summary>
